    ...
    <li className="relative group">
      {item.type === "link" ? (
        <>
          ...
          <span className="cursor-pointer text-blue-500 absolute top-0 right-0 font-bold transition-all duration-500 group-hover:right-[85%] opacity-0 group-hover:opacity-100">
            /
          </span>
        </>
      ) : (
  ...
  return (
    <section className="sticky top-0 left-0 right-0 z-50 bg-white">
      <header className="container mx-auto px-5 flex items-center justify-between py-4">
        ...
        >
          <ul className="text-white lg:text-dark-soft flex flex-col items-center gap-y-5 lg:flex-row gap-x-2 font-semibold">
